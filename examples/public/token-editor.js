...
const TOKENS = [
  ...
  { name: '--elv-bg-info', group: 'Backgrounds', light: '#0073f5', dark: '#2e90ff' },
  ...
  { name: '--elv-bg-critical', group: 'Backgrounds', light: '#eb2000', dark: '#ffa394' },
  { name: '--elv-bg-critical-140', group: 'Backgrounds', light: '#b21800', dark: '#FFD7D1' },
  ...
  { name: '--elv-bg-success-20', group: 'Backgrounds', light: '#d0f6f1', dark: '#072723' },
  { name: '--elv-bg-success-40', group: 'Backgrounds', light: '#a9efe5', dark: '#0f5249' },
  { name: '--elv-bg-success', group: 'Backgrounds', light: '#1fa896', dark: '#5be1cf' },
  ...
  { name: '--elv-text-link-visited', group: 'Foregrounds', light: '#2e90ff', dark: '#2e90ff' },
  ...
  { name: '--elv-text-success-data', group: 'Foregrounds', light: '#1fa896', dark: '#5be1cf' },
  { name: '--elv-text-warning', group: 'Foregrounds', light: '#665000', dark: '#fff9e5' },
  { name: '--elv-text-critical', group: 'Foregrounds', light: '#b21800', dark: '#ffa394' },
  ...
  { name: '--elv-border-info', group: 'Borders', light: '#0073f5', dark: '#2e90ff' },
  { name: '--elv-border-success', group: 'Borders', light: '#1fa896', dark: '#5be1cf' },
  { name: '--elv-border-critical', group: 'Borders', light: '#eb2000', dark: '#ffa394' },
...
const DARK_PRIMITIVES = {
  ...
  yellow: {
    ...
    100: '#ffc800', 120: '#cca000', 140: '#997800', 160: '#665000', 180: '#332800'
  }
};
